...
const Movable = require('@ucbuilder:/controls/Movable.uc.js');
const { objectOpt, arrayOpt, pathInfo } = require('@ucbuilder:/build/common.js');
const { tabChilds } = require('@ucbuilder:/controls/Splitter.uc.enumAndMore.js');
...
const messageBox = require('@ucbuilder:/controls/messageBox.uc.js');
